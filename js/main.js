$(document).ready(function () {
	...
	// Add a script tag in the HTML file and include this JavaScript code
	...
	if (isTouchDevice()) {
		...
		dropdownToggle.addEventListener('mouseenter', toggleDropdown);
		dropdownToggle.addEventListener('mouseleave', toggleDropdown);
	}
