...
function ownKeys(a, b) {
    ...
    function a() {
        ...
        var h = document.getElementsByClassName(e.position)[0],
            j = document.createElement("div"); j.className = "vt-card ".concat(g),
                j.innerHTML += i[g], j.options = _objectSpread(_objectSpread({}, e),
                    {
                        message: a, type: g, yPos: -1 < e.position.indexOf("top") ? "top" : "bottom", isFocus: !1
                    }
                ),
                b(j), c(j), d(j), f(j), h.appendChild(j)
    } function b(a) {
        var b = document.createElement("div"); b.className = "text-group", a.options.title && (b.innerHTML = "<h4>".concat(a.options.title, "</h4>")), b.innerHTML += "<p>".concat(a.options.message, "</p>"), a.appendChild(b)
    } function c(a) {
